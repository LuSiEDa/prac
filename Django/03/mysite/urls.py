...
from todolist.views import todolist, todo_info
...
urlpatterns = [
    ...
    path('todo/<int:pk>/', todo_info, name='todo_info'),

    path('accounts/login/', member_views.log_in, name='login' ),
    path('accounts/signup/', member_views.sign_up, name='signup' ),
